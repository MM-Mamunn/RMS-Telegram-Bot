...
export function createBot(): Bot<RmsBotContext> {
  const instance = new Bot<RmsBotContext>(env.telegram.token);
...
export async function configureTelegramCommands(): Promise<void> {
